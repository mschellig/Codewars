...
//    {
//        Console.WriteLine("Start solving loopover");
...
//                for (int i = 0; i < loopover._dimension_x / 2; i++)
//                {
//                    loopover._workingboard.MoveBoard('L', loopover._dimension_y - 1);
//                    loopover._workingboard.MoveBoard('D', loopover._dimension_x - 1);
//                    loopover._workingboard.MoveBoard('L', loopover._dimension_y - 1);
//                    loopover._workingboard.MoveBoard('U', loopover._dimension_x - 1);
//                }
//                loopover._workingboard.MoveBoard('L', loopover._dimension_y - 1);
